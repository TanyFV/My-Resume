...
function calculateSum() {
    ...
    const wedsiteCart = document.querySelector('#calculator-form-input-cart input:checked');
    const wedsiteReseption = document.querySelector('#calculator-form-input-reseption input:checked');
    ...
    const wedsiteCartValue = convertCartOptionToPrice(wedsiteCart.value);
    const wedsiteReseptionValue = convertReceptionOptionToPrice(wedsiteReseption.value);
    // console.log(wedsiteCartValue);
    // console.log(websiteTypeValue);
    // console.log(technologiesValue);
    // console.log(wedsiteCartValue);
    // console.log(wedsiteReseptionValue)
    const totalSum = websiteTypeValue + technologiesValue + wedsiteCartValue + wedsiteReseptionValue;
    renderSum(totalSum);
}
